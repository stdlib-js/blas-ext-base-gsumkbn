...
```javascript
gsumkbn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsumkbn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-gsumkbn/tags). For example,

```javascript
gsumkbn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsumkbn@v0.3.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var gsumkbn = require( 'path/to/vendor/umd/blas-ext-base-gsumkbn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsumkbn@umd/browser.js"></script>
```
...
var v = gsumkbn( 4, x1, 2 );
// returns 5.0
```

#### gsumkbn.ndarray( N, x, strideX, offsetX )
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gsumkbn.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gsumkbn

[test-image]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/actions/workflows/test.yml?query=branch:v0.3.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gsumkbn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gsumkbn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gsumkbn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gsumkbn/main
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gsumkbn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gsumkbn/main/LICENSE
